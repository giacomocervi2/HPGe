...
G4VPhysicalVolume *HPGeDetectorConstruction::Construct()
{
	...
	//vacuum placement
	G4double vac_z = 27.35953 * mm + 4.0 * mm;
	...
	G4double HPGe_z = 27.35953 * mm;
	G4double HPGe_rMin = 0. * mm;
	G4double HPGe_rMax = 26.6862494 * mm; 
	...
	//hole
	G4double hole_length = 22.0 * mm; 
	G4double hole_rMin = 0. * mm;
	G4double hole_rMax = 7.46077945 * mm; 
